...
@section('title', 'kişisel bir blog...')
@section('page_title', 'Searching Result: '.$keyword)
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 icerik-ana">
                ...
                @if($articles->count() == 0)
                    <p>There is no article like: "{{$keyword}}"</p>

                @endif

                <p>{{$articles->count() }} articles has founded like: "{{ $keyword  }}"</p>
                    ...
                    <div class="ana-makale">
                        ...
                        <div class="row icerik">
                            <div class="col-md-5">
                                <div class="">
                                    @if($article->image != '' or $article->image != null)
                                        ...
                                        @else
                                         <img src="{{ asset('uploads/')  }}/noimage.jpg" class="img-fluid" alt="">
                                    @endif
                                </div></div>
                            <div class="col-md-7 icerik-yazi">
                                ...
                                <div class="devam">
                                    <a href="{{ route('single', [$article->getCategory->slug, $article->slug])   }}"> <button class="btn btn-success"><p>Devamını Oku >></p></button></a></div>
                            </div>
                        </div>
                    </div>
